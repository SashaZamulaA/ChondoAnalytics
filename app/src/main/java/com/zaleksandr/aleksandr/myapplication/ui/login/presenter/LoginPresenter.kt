package com.zaleksandr.aleksandr.myapplication.ui.login.presenter

import android.app.Application
import com.zaleksandr.aleksandr.myapplication.AndroidApplication
import com.zaleksandr.aleksandr.myapplication.BasePresenter
import com.zaleksandr.aleksandr.myapplication.isEmailAddressValid
import com.zaleksandr.aleksandr.myapplication.ui.login.ILoginActivity
...
class LoginPresenter(loginView: LoginActivity, applicationComponent: Application): BasePresenter<LoginActivity>(loginView){
    ...
    fun onValidateAndLogin() {
        ...
        if (isValidateSuccess) view?.apply { onLoginSuccess{} }
    }
