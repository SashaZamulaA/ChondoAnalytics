package com.zamulaaleksandr.aleksandr.myapplication.ui.commonResult
...
import com.zamulaaleksandr.aleksandr.myapplication.ui.commonResult.adapter.CommonResultAdapter
...
//    }
    ...
    private fun bottomMenuInit(rootView: View) {
        ...
        rootView.bottom_navigation.setOnNavigationItemSelectedListener { item ->
            when (item.itemId) {
                com.zamulaaleksandr.aleksandr.myapplication.R.id.menu_year -> {
//                    showLoading()
                    adapter?.perioSelected(CommonResultAdapter.ClickByFilter.YEAR)
//                    hideLoading()
                }
                com.zamulaaleksandr.aleksandr.myapplication.R.id.menu_month -> {
                    adapter?.perioSelected(CommonResultAdapter.ClickByFilter.MONTH)
                }
                com.zamulaaleksandr.aleksandr.myapplication.R.id.menu_week -> {
                    adapter?.perioSelected(CommonResultAdapter.ClickByFilter.WEEK)
                }
                com.zamulaaleksandr.aleksandr.myapplication.R.id.menu_day -> {
